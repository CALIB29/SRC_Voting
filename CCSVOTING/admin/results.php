    ...
    <div class="app-container">
        ...
        <main class="main-content">
            ...
            <div class="floating-actions">
                <button onclick="window.print()" class="modern-button primary"> <i class="fas fa-print"></i> Export
                    Report
                </button>
                ...
                <?php if (!$is_viewing_archive): ?>
                    <form method="POST" style="display: inline;"
                        ...
                        <button type="submit" class="modern-button danger"> <i class="fas fa-stop-circle"></i> End Election
                            Now
                        </button>
                    </form>
                <?php else: ?>
                    <a href="manage_history.php" class="modern-button secondary"> <i class="fas fa-arrow-left"></i> Back to
                        History
                    </a>
                <?php endif; ?>
            </div>
