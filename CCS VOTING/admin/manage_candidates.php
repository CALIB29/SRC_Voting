...
<body>
        ...
        <main class="main-content">
            ...
            <div class="modern-card" style="margin-bottom: 2rem;">
                <div class="card-header"
                    ...
                    </div><button class="modern-button secondary" type="button" onclick="toggleAddForm()"><i
                ...
                <div class="card-body" id="addCandidateFormContainer"
                    ...
                    <?php if (!$active_election_id): ?>
                        <div
                            style="text-align: center; padding: 3rem; background: var(--bg-secondary); border-radius: 16px; border: 1px dashed var(--border);">
                            ...
                            <p style="color: var(--text-secondary); max-width: 400px; margin: 0 auto;">You cannot add
                        ...
                        <form method="post" enctype="multipart/form-data" class="modern-form">
                            ...
                            <div
                                ...
                                <div class="form-group"><label class="form-label">First Name</label><input type="text"
                                        name="first_name" class="form-control" required placeholder="e.g. Juan"></div>
                                <div class="form-group"><label class="form-label">Middle Name (Optional)</label><input
                                        type="text" name="middle_name" class="form-control" placeholder="e.g. Protacio">
                                </div>
                                <div class="form-group"><label class="form-label">Last Name</label><input type="text"
                                        name="last_name" class="form-control" required placeholder="e.g. Dela Cruz"></div>
                            </div>
                            <div
                                style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
                                <div class="form-group"><label class="form-label">Year Level</label><select name="year"
                                ...
                                <div class="form-group"><label class="form-label">Section</label><input type="text"
                                        name="section" class="form-control" required placeholder="e.g. BSCS-3A"></div>
                                <div class="form-group"><label class="form-label">Position</label><select name="position"
                                        class="form-control" required>
                            ...
                            <div class="form-group" style="margin-top: 1.5rem;"><label class="form-label">Platform /
                                    Statement</label><textarea name="platform" class="form-control" rows="4"
                            ...
                            <div class="form-group" style="margin-top: 1.5rem;"><label class="form-label">Candidate
                                    Photo</label>
                                <div
                                    style="display: flex; align-items: center; gap: 1.5rem; padding: 1rem; background: var(--bg-secondary); border-radius: 12px; border: 1px solid var(--border);">
                                    <div id="photoPreview"
                                        ...
                                        <i class="fas fa-image"
                                            style="font-size: 1.5rem; color: var(--text-secondary);"></i>
                                    </div>
                                    <div style="flex: 1;"><input type="file" name="photo" id="candidatePhoto"
                                            ...
                                            style="margin-left: 1rem; font-size: 0.875rem; color: var(--text-secondary);">No
                                            file chosen</span></div>
                                </div><small
                                    style="display: block; margin-top: 0.5rem; color: var(--text-secondary);">Recommended:
                                    300x300px square image (max 2MB)</small>
                            </div>
                            <div style="margin-top: 2rem; display: flex; justify-content: flex-end; gap: 1rem;"> <button
                                    type="reset" class="modern-button secondary">Reset Form</button> <button type="submit"
                                    name="add_candidate" class="modern-button primary"> <i class="fas fa-save"></i> Save
                    ...
                    <div class="modern-card">
                        <div class="card-header"
                            ...
                            <div style="display: flex; align-items: center; gap: 0.75rem;">
                                ...
                                <div>
                                    ...
                                    <p style="font-size: 0.875rem; color: var(--text-secondary);"><span
                        ...
                        <div class="card-body" style="padding: 0;">
                                    ...
                                    <tbody id="candidates-tbody">
                                        <?php if (empty($candidates)): ?>
                                            <tr id="no-candidates-row">
                                                <td colspan="6" style="text-align: center; padding: 4rem;">
                                                    <div
                                                        style="font-size: 3rem; color: var(--border); margin-bottom: 1rem;">
                                            ...
                                            <?php foreach ($candidates as $candidate): ?>
                                                <tr class="candidate-row">
                                                    ...
                                                    <td style="text-align: right; padding-right: 2rem;">
                                                        <button type="button" class="modern-button secondary"
                                        ...
                                        <tr id="no-search-results" style="display: none;">
                                            <td colspan="6" style="text-align: center; padding: 4rem;">
                                                ...
                                                <p style="color: var(--text-secondary);">No candidates found matching
                                                    your search.</p>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div
                                style="padding: 1.5rem; border-top: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center;">
                                <p style="font-size: 0.875rem; color: var(--text-secondary);">
                                    Showing <span id="showing-count"><?php echo count($candidates); ?></span> entries
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content"
            style="max-width: 800px; border-radius: 20px; overflow: hidden; border: 1px solid rgba(255, 255, 255, 0.2);">
            <div class="modal-header"
                style="background: var(--bg-primary); padding: 1.5rem; border-bottom: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center;">
                <div style="display: flex; align-items: center; gap: 0.75rem;">
                    <div
                        style="padding: 0.5rem; background: var(--primary-light); border-radius: 8px; color: var(--primary);">
                        <i class="fas fa-edit"></i>
                    </div>
                    <h2 style="font-size: 1.25rem; font-weight: 700;">Edit Candidate</h2>
                </div>
            ...
            <div class="modal-body" style="padding: 2rem; background: var(--bg-primary);">
                <form id="editCandidateForm" method="post" enctype="multipart/form-data" class="modern-form">
                    ...
                    <div
                        ...
                        <div class="form-group">
                            ...
                            <select id="edit_year" name="edit_year" class="form-control" required>
                                <option value="1st Year">1st Year</option>
                                <option value="2nd Year">2nd Year</option>
                                <option value="3rd Year">3rd Year</option>
                                <option value="4th Year">4th Year</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="edit_section" name="edit_section" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Position</label>
                            <select id="edit_position" name="edit_position" class="form-control" required>
                                <option value="President">President</option>
                                <option value="Vice President">Vice President</option>
                                <option value="Secretary">Secretary</option>
                                <option value="Treasurer">Treasurer</option>
                    ...
                    <div class="form-group" style="margin-top: 1.5rem;">
                        ...
                        <textarea id="edit_platform" name="edit_platform" class="form-control" rows="4"></textarea>
                    </div>
                    ...
                    <div
                        ...
                        <div class="form-group">
                            ...
                            <div
                                style="width: 100%; aspect-ratio: 1; background: var(--bg-secondary); border-radius: 12px; overflow: hidden; border: 1px solid var(--border);">
                        ...
                        <div class="form-group">
                            ...
                            <div
                                style="padding: 1.5rem; background: var(--bg-secondary); border-radius: 12px; border: 1px dashed var(--border); text-align: center;">
                                ...
                                <div id="edit_file_name"
                                    style="margin-top: 0.75rem; font-size: 0.875rem; color: var(--text-secondary);">No
                                    file chosen</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="margin-top: 2rem; display: flex; justify-content: flex-end; gap: 1rem;">
                        <button type="button" class="modern-button secondary" onclick="closeEditModal()">Cancel</button>
                        <button type="submit" name="update_candidate" class="modern-button primary">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (searchInput) {
                searchInput.addEventListener('input', function () {
                    ...
                    // The candidate-count span is for total candidates, not filtered.
                    // If you want it to reflect filtered count, uncomment the line below:
