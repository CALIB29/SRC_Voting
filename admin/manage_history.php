        ...
        <main class="main-content">
            <header class="page-header">
                <div class="welcome-text">
                    <h1>Global Election History</h1>
                    <p>Manage past election records for all departments</p>
                </div>
            </header>
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div style="margin-top: 2rem; display: flex; justify-content: flex-end; gap: 1rem;">
                            ...
                            <button type="submit" name="save_history" class="btn btn-schedule">
                                <i class="fas fa-save"></i> <?php echo $edit_mode ? 'Update Record' : 'Save Record'; ?>
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="modern-card">
                <div class="card-header" style="padding: 1.5rem; border-bottom: 1px solid var(--border);">
                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                        ...
                        <div>
                            <h2 style="font-size: 1.25rem; font-weight: 700;">All History Records</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            while ($row = $stmt->fetch()):
                                ...
                                <tr style="border-bottom: 1px solid var(--border);">
                                    ...
                                    <td style="padding: 1rem;">
                                        <div style="font-weight: 700;"><?php echo htmlspecialchars($row['fullname']); ?>
                                        </div>
                                        <div style="font-size: 0.8rem; color: var(--primary);">
                                            <?php echo htmlspecialchars($row['position']); ?></div>
                                    </td>
                                    <td style="padding: 1rem;"><?php echo htmlspecialchars($row['year_section']); ?></td>
                                    <td style="padding: 1rem;">
                                        <span
