...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['set_schedule'])) {
        ...
        $keep_schedule_open = true;
        $pdo->exec("DELETE FROM vot_voting_schedule");
        $schedule_message = "Voting schedule has been reset!";
    }
}
        ...
        <main class="main-content">
            ...
            <div class="modern-card">
                <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 2rem;">
                    ...
                    <h3 style="font-size: 1.25rem; font-weight: 700;">Set Election Window</h3>
                </div>
                ...
                <form method="POST">
                    ...
                    <div style="margin-top: 2rem; display: flex; gap: 1rem; flex-wrap: wrap;">
                        <button type="submit" name="set_schedule" class="modern-btn modern-btn-primary">Update
                            Schedule</button>
